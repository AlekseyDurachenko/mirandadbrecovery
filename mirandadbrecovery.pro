...
# current project (.pri)
include($$PWD/mirandadbrecovery-sources.pri)
include($$PWD/mirandadbrecovery-tests.pri)
include($$PWD/mirandadbrecovery-unixinstall.pri)
include($$PWD/mirandadbrecovery-unixrules.pri)
